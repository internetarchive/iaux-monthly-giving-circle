...
`;class Oo extends S{static get styles(){return m`
  ...
  `;s([h({type:Boolean,reflect:!0})],Fe.prototype,"isDisabled",void 0);s([h({type:Object})],Fe.prototype,"clickHandler",void 0);s([b("button")],Fe.prototype,"button",void 0);Fe=s([A("ia-mgc-button")],Fe);let Ke=class extends S{constructor(){super(...arguments),this.plans=[],this.canEdit=!1}render(){return p`
