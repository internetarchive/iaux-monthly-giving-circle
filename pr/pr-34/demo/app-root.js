...
`;class Ro extends S{static get styles(){return m`
  ...
  `;s([h({type:Boolean,reflect:!0})],De.prototype,"isDisabled",void 0);s([h({type:Object})],De.prototype,"clickHandler",void 0);s([b("button")],De.prototype,"button",void 0);De=s([I("ia-mgc-button")],De);let Ke=class extends S{constructor(){super(...arguments),this.plans=[],this.canEdit=!1}render(){return p`
      <section class="monthly-giving-circle">
        <ul>
          ${this.plans.map(e=>{var t,n,o,a,r,d,l,c,u,v,y,f,A,w,D,R,z,Y;let ee=(n=(t=e.payment)===null||t===void 0?void 0:t.paymentMethodType)!==null&&n!==void 0?n:"Method not found";ee==="creditCard"&&(ee="Credit card");const $e=(a=(o=e.payment)===null||o===void 0?void 0:o.cardType)!==null&&a!==void 0?a:"Card type not found",ot=!((r=e.payment)===null||r===void 0)&&r.last4?`...${(d=e.payment)===null||d===void 0?void 0:d.last4}`:"CC number not found";return p`
                ...
                <div class="info">
                  ...
                  <div class="payment-details">
                    ...
                    ${((w=e.payment)===null||w===void 0?void 0:w.paymentMethodType)!=="creditCard"?p`<p>
                          Expires:
                          ${(R=(D=e.payment)===null||D===void 0?void 0:D.expirationMonth)!==null&&R!==void 0?R:"month not found"}/${(Y=(z=e.payment)===null||z===void 0?void 0:z.expirationYear)!==null&&Y!==void 0?Y:"year not found"}
                        </p>`:C}
                  </div>
...
`;let Vt=class extends S{constructor(){super(...arguments),this.config=new ue}render(){return p`
    ...
    `}static get styles(){const e=m`var(--modalLogoSize, 6.5rem)`,t=m`var(--processingImageSize, 7.5rem)`,n=m`var(--modalCornerRadius, 1rem)`,o=m`var(--modalBorder, 2px solid black)`,a=m`var(--modalBottomMargin, 2.5rem)`,r=m`var(--modalTopMargin, 5rem)`,d=m`var(--modalHeaderBottomPadding, 0.5em)`,l=m`var(--modalBottomPadding, 2rem)`,c=m`var(--modalScrollOffset, 5px)`,u=m`var(--modalTitleFontSize, 1.8rem)`,v=m`var(--modalSubtitleFontSize, 1.4rem)`,y=m`var(--modalHeadlineFontSize, 1.6rem)`,f=m`var(--modalMessageFontSize, 1.4rem)`,A=m`var(--modalTitleLineHeight, normal)`,w=m`var(--modalSubtitleLineHeight, normal)`,D=m`var(--modalHeadlineLineHeight, normal)`,R=m`var(--modalMessageLineHeight, normal)`;return m`
      .processing-logo {
        margin: auto;
        width: ${t};
        height: ${t};
      ...
      ${this.currentlyEditing?p`
            <form id="edit-plan-payment-method" @submit=${this.submitPaymentMethodChange}>
              ...
              <ia-mgc-button
                ...
                class="primary"
                type="submit"
                .clickHandler=${async(y,f)=>{var A,w,D;console.log({iaButton:f,event:y});const R=f;if(R.isDisabled=!0,!((A=this.creditCardElement)===null||A===void 0?void 0:A.reportValidity())){R.isDisabled=!1;return}const Y=await((w=this.braintreeManagerElement)===null||w===void 0?void 0:w.validateCreditCardFields());if(!Y){R.isDisabled=!1;return}const ee=new Hi({paymentMethodInfo:Y,donorContactInfo:(D=this.contactFormElement)===null||D===void 0?void 0:D.donorContactInfo,paymentProvider:this.selectedPaymentProvider});this.dispatchEvent(new CustomEvent("UpdatePaymentMethod",{detail:{newPaymentMethodRequest:ee}}))}}
