 ...
 */const Ye=Ze(class extends Ke{constructor(n){var t;if(super(n),n.type!==Fe.ATTRIBUTE||n.name!=="class"||((t=n.strings)===null||t===void 0?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(n){return" "+Object.keys(n).filter(t=>n[t]).join(" ")+" "}update(n,[t]){var e,i;if(this.it===void 0){this.it=new Set,n.strings!==void 0&&(this.nt=new Set(n.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in t)t[o]&&!(!((e=this.nt)===null||e===void 0)&&e.has(o))&&this.it.add(o);return this.render(t)}const s=n.element.classList;this.it.forEach(o=>{o in t||(s.remove(o),this.it.delete(o))});for(const o in t){const r=!!t[o];r===this.it.has(o)||!((i=this.nt)===null||i===void 0)&&i.has(o)||(r?(s.add(o),this.it.add(o)):(s.remove(o),this.it.delete(o)))}return R}});let xt=class extends f{render(){return _`<slot></slot>`}};xt.styles=J`
  ...
  `;xt=m([Z("iaux-button-style")],xt);let G=class extends f{constructor(){super(...arguments),this.receipts=[],this.donationEmailStatusMap=null}updated(t){t.has("receipts")&&this.updateReceiptSentMap(),t.has("donationEmailStatusMap")&&console.log("donationEmailStatusMap UPDATED ---- ",this.donationEmailStatusMap)}updateReceiptSentMap(){if(!this.receipts.length)this.donationEmailStatusMap=null;else{const t={};this.receipts.forEach(e=>{t[e.id]={id:e.id,emailStatus:""}}),this.donationEmailStatusMap=t}}donationAmountFormatted(t){return`USD $${t}`}dateFormatted(t){const e=t.split("-"),i=e[0],s=parseInt(e[1],10),o=e[2];return`${{1:"January",2:"February",3:"March",4:"April",5:"May",6:"June",7:"July",8:"August",9:"September",10:"October",11:"November",12:"December"}[s]} ${o}, ${i}`}emailReceipt(t){this.dispatchEvent(new CustomEvent("EmailReceiptRequest",{detail:{donation:t}}))}async emailSent(t){const e=this.donationEmailStatusMap;this.donationEmailStatusMap=null,await this.updateComplete;const i={...e},{id:s}=t;i[s]=t,this.donationEmailStatusMap={...i},console.log("RECEIPTS -- emailSent",this.donationEmailStatusMap,t)}emailStatusMessageToDisplay(t){switch(t.emailStatus){case"success":return"✓ Email receipt sent";case"fail":return"✖ Email receipt failed";default:return""}}ctaButtonText(t,e){return t.status==="pending"?"Unavailable":e?.emailStatus==="pending"?"Sending...":"Email receipt"}render(){return _`
                  ...
                  <tr id=${`donation-${t.id}`}>
                    ...
                    <td>
                      <div class="request-receipt">
                        ...
                        >
                          <button
                            @click=${r=>{if(r.target.disabled=!0,!s&&(this.emailReceipt(t),this.donationEmailStatusMap)){const h={...this.donationEmailStatusMap};h[t.id].emailStatus="pending",this.donationEmailStatusMap=h}}}
                            ?disabled=${s}
                          >
  ...
  `;m([y({type:Array})],G.prototype,"receipts",void 0);m([y({type:Object})],G.prototype,"donationEmailStatusMap",void 0);G=m([Z("iaux-mgc-receipts")],G);let I=class extends f{constructor(){super(...arguments),this.patronName="",this.receipts=[],this.updates=[],this.viewToDisplay="welcome"}createRenderRoot(){return this}get receiptListElement(){return this.querySelector("iaux-mgc-receipts")}updateReceived(t){this.receiptListElement.emailSent({id:t.donationId,emailStatus:t.status}),this.updates.unshift(t)}get showReceiptsCTA(){return _`
