 ...
 */var ft;((ft=window.HTMLSlotElement)===null||ft===void 0?void 0:ft.prototype.assignedElements)!=null;const We="mailto:donations@archive.org?subject=Please%20Confirm%20my%20Monthly%20Giving%20Circle%20Status&body=Dear%20Philanthropy%20Team%2C%0A%0AI%20am%20already%20a%20member%20of%20the%20Monthly%20Giving%20Circle%2C%20but%20I%20do%20not%20see%20my%20recurring%20donation%20under%20Account%20Settings.%20Please%20use%20the%20following%20information%20to%20locate%20my%20donation%3A%0A%0AFull%20name%3A%20____________%0A%0AEmail%20address(es)%3A%20____________%0A%0A*Please%20provide%20any%20alternative%20email%20addresses%20you%20may%20have%20used%20to%20create%20your%20recurring%20donation.%0A%0AIf%20you%20have%20access%20to%20a%20monthly%20donation%20receipt%2C%20please%20include%20a%20screenshot%20with%20your%20email.%0A%0AThanks!";let D=class extends _{constructor(){super(...arguments),this.patronName="",this.baseHost="archive.org",this.defaultMonthlyDonationAmount=5}render(){const t=`https://${this.baseHost}/donate/?amt=${this.defaultMonthlyDonationAmount}&contrib_type=monthly&origin=iawww-usrsttng`;return f`
  ...
  `;m([y({type:String})],D.prototype,"patronName",void 0);m([y({type:String})],D.prototype,"baseHost",void 0);m([y({type:String})],D.prototype,"defaultMonthlyDonationAmount",void 0);D=m([Z("iaux-mgc-welcome")],D);const Ge=f`
<svg
  viewBox="0 0 40 40"
...
`;class Fe extends _{static get styles(){return F`
      :host {
    ...
    `}render(){return Ge}}customElements.define("ia-icon-donate",Fe);let st=class extends _{constructor(){super(...arguments),this.titleStyle="heart"}get heart(){return this.titleStyle==="heart"?f` <div class="icon-donate"><ia-icon-donate></ia-icon-donate></div> `:$}render(){return f`
      <div>
        <h2>
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ye=Ze(class extends Ke{constructor(n){var t;if(super(n),n.type!==Je.ATTRIBUTE||n.name!=="class"||((t=n.strings)===null||t===void 0?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(n){return" "+Object.keys(n).filter(t=>n[t]).join(" ")+" "}update(n,[t]){var e,i;if(this.it===void 0){this.it=new Set,n.strings!==void 0&&(this.nt=new Set(n.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in t)t[o]&&!(!((e=this.nt)===null||e===void 0)&&e.has(o))&&this.it.add(o);return this.render(t)}const s=n.element.classList;this.it.forEach(o=>{o in t||(s.remove(o),this.it.delete(o))});for(const o in t){const r=!!t[o];r===this.it.has(o)||!((i=this.nt)===null||i===void 0)&&i.has(o)||(r?(s.add(o),this.it.add(o)):(s.remove(o),this.it.delete(o)))}return R}});let Ct=class extends _{render(){return f`<slot></slot>`}};Ct.styles=F`
    ::slotted(*) {
      height: 30px;
      border: none;
      cursor: pointer;
  ...
  `;Ct=m([Z("iaux-button-style")],Ct);let G=class extends _{constructor(){super(...arguments),this.receipts=[],this.receiptDispatcher=null}updated(t){t.has("receipts")&&this.updateReceiptSentMap(),t.has("receiptDispatcher")&&console.log("receiptDispatcher UPDATED ---- ",this.receiptDispatcher)}updateReceiptSentMap(){if(!this.receipts.length)this.receiptDispatcher=null;else{const t={};this.receipts.forEach(e=>{t[e.id]={id:e.id,emailStatus:""}}),this.receiptDispatcher=t}}emailReceipt(t){this.dispatchEvent(new CustomEvent("EmailReceiptRequest",{detail:{donation:t}}))}donationAmountFormatted(t){return`USD $${t}`}dateFormatted(t){const e=t.split("-"),i=e[0],s=parseInt(e[1],10),o=e[2];return`${{1:"JAN",2:"FEB",3:"MAR",4:"APR",5:"MAY",6:"JUN",7:"JUL",8:"AUG",9:"SEP",10:"OCT",11:"NOV",12:"DEC"}[s]} ${o}, ${i}`}async emailSent(t){const e=this.receiptDispatcher;this.receiptDispatcher=null,await this.updateComplete;const i={...e},{id:s}=t;i[s]=t,this.receiptDispatcher={...i},console.log("RECEIPTS -- emailSent",this.receiptDispatcher,t)}emailStatusMessageToDisplay(t){switch(t.emailStatus){case"success":return"✓ Sent";case"fail":return"✖ Failed";default:return""}}ctaButtonText(t,e){return t.status==="pending"?"Unavailable":e?.emailStatus==="pending"?"Sending...":"Email receipt"}render(){return f`
      <section id="recent-donations-list">
        <table>
          ...
          ${this.receipts.length?this.receipts.map(t=>{var e;const i=(e=this.receiptDispatcher)===null||e===void 0?void 0:e[t.id],s=i?.emailStatus==="pending"||t.status==="pending",o=!i||!i.emailStatus?$:f`<span
