 ...
 */var yt;((yt=window.HTMLSlotElement)===null||yt===void 0?void 0:yt.prototype.assignedElements)!=null;const We="mailto:donations@archive.org?subject=Please%20Confirm%20my%20Monthly%20Giving%20Circle%20Status&body=Dear%20Philanthropy%20Team%2C%0A%0AI%20am%20already%20a%20member%20of%20the%20Monthly%20Giving%20Circle%2C%20but%20I%20do%20not%20see%20my%20recurring%20donation%20under%20Account%20Settings.%20Please%20use%20the%20following%20information%20to%20locate%20my%20donation%3A%0A%0AFull%20name%3A%20____________%0A%0AEmail%20address(es)%3A%20____________%0A%0A*Please%20provide%20any%20alternative%20email%20addresses%20you%20may%20have%20used%20to%20create%20your%20recurring%20donation.%0A%0AIf%20you%20have%20access%20to%20a%20monthly%20donation%20receipt%2C%20please%20include%20a%20screenshot%20with%20your%20email.%0A%0AThanks!";let T=class extends y{constructor(){super(...arguments),this.patronName="",this.baseHost="archive.org",this.defaultMonthlyDonationAmount=5}render(){const t=`https://${this.baseHost}/donate/?amt=${this.defaultMonthlyDonationAmount}&contrib_type=monthly&origin=iawww-usrsttng`;return _`
  ...
  `;m([g({type:String})],T.prototype,"patronName",void 0);m([g({type:String})],T.prototype,"baseHost",void 0);m([g({type:String})],T.prototype,"defaultMonthlyDonationAmount",void 0);T=m([F("iaux-mgc-welcome")],T);const Ge=_`
<svg
  viewBox="0 0 40 40"
...
`;class qe extends y{static get styles(){return q`
  ...
  `;m([g({type:String})],it.prototype,"titleStyle",void 0);it=m([F("iaux-mgc-title")],it);let st=class extends y{constructor(){super(...arguments),this.styleType="primary"}render(){return _`<slot></slot>`}};st.styles=q`
    ::slotted(button) {
      height: 30px;
      border: none;
      cursor: pointer;
