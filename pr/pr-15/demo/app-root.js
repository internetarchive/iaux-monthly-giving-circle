 ...
 */var ft;((ft=window.HTMLSlotElement)===null||ft===void 0?void 0:ft.prototype.assignedElements)!=null;const Ye="mailto:donations@archive.org?subject=Please%20Confirm%20my%20Monthly%20Giving%20Circle%20Status&body=Dear%20Philanthropy%20Team%2C%0A%0AI%20am%20already%20a%20member%20of%20the%20Monthly%20Giving%20Circle%2C%20but%20I%20do%20not%20see%20my%20recurring%20donation%20under%20Account%20Settings.%20Please%20use%20the%20following%20information%20to%20locate%20my%20donation%3A%0A%0AFull%20name%3A%20____________%0A%0AEmail%20address(es)%3A%20____________%0A%0A*Please%20provide%20any%20alternative%20email%20addresses%20you%20may%20have%20used%20to%20create%20your%20recurring%20donation.%0A%0AIf%20you%20have%20access%20to%20a%20monthly%20donation%20receipt%2C%20please%20include%20a%20screenshot%20with%20your%20email.%0A%0AThanks!";let R=class extends g{constructor(){super(...arguments),this.patronName="",this.baseHost="archive.org",this.defaultMonthlyDonationAmount=5}render(){const t=`https://${this.baseHost}/donate/?amt=${this.defaultMonthlyDonationAmount}&contrib_type=monthly&origin=iawww-usrsttng`;return y`
    ...
    `}get mailToInquiryLink(){const t="mailto:donations@archive.org?subject=Tell%20me%20more%20about%20the%20Monthly%20Giving%20Circle&body=Hello%2C%20I%20am%20an%20archive%20member%20and%20want%20to%20know%20about%20the%20Monthly%20Giving%20Circle.%20%20Best%2C%20",e=encodeURIComponent(this.patronName);return`${t}${e}`}};R.styles=Y`
    :host {
  ...
  `;m([f({type:String})],R.prototype,"patronName",void 0);m([f({type:String})],R.prototype,"baseHost",void 0);m([f({type:String})],R.prototype,"defaultMonthlyDonationAmount",void 0);R=m([Z("iaux-mgc-welcome")],R);const Fe=y`
<svg
  viewBox="0 0 40 40"
...
`;class Ze extends g{static get styles(){return Y`
      :host {
    ...
    `}render(){return Fe}}customElements.define("ia-icon-donate",Ze);let nt=class extends g{constructor(){super(...arguments),this.titleStyle="heart"}get heart(){return this.titleStyle==="heart"?y` <div class="icon-donate"><ia-icon-donate></ia-icon-donate></div> `:$}render(){return y`
      <div>
        <h2>
  ...
  `;m([f({type:String})],nt.prototype,"titleStyle",void 0);nt=m([Z("iaux-mgc-title")],nt);let I=class extends g{constructor(){super(...arguments),this.isDisabled=!1}render(){return y`
      <button
  ...
  `;m([f({type:Boolean,reflect:!0})],I.prototype,"isDisabled",void 0);m([f({type:Function})],I.prototype,"clickHandler",void 0);m([We("button")],I.prototype,"button",void 0);I=m([Z("iaux-button")],I);let W=class extends g{constructor(){super(...arguments),this.receipts=[],this.receiptDispatcher=null}shouldUpdate(t){return!!t.has("receiptDispatcher")}updated(t){t.has("receipts")&&this.updateReceiptSentMap(),t.has("receiptDispatcher")&&console.log("receiptDispatcher UPDATED ---- ",this.receiptDispatcher)}updateReceiptSentMap(){if(!this.receipts.length)this.receiptDispatcher=null;else{const t={};this.receipts.forEach(e=>{t[e.id]={id:e.id,emailStatus:""}}),this.receiptDispatcher=t}}emailReceipt(t){this.dispatchEvent(new CustomEvent("EmailReceiptRequest",{detail:{donation:t}}))}donationAmountFormatted(t){return`USD $${t}`}async emailSent(t){var e;const i=this.receiptDispatcher;this.receiptDispatcher=null,await this.updateComplete;const s={...i},{id:o}=t;s[o]=t,this.receiptDispatcher={...s},console.log("RECEIPTS -- emailSent",this.receiptDispatcher,t);const r=CSS.escape(o),h=(e=this.shadowRoot)===null||e===void 0?void 0:e.querySelector(`#donation-${r} iaux-button`);h.isDisabled=!1}emailStatusMessageToDisplay(t){switch(t.emailStatus){case"success":return"✓ Sent";case"fail":return"✖ Failed";default:return""}}ctaButtonText(t,e){return e?.emailStatus==="pending"?"Sending...":"Email receipt"}render(){return y`
  ...
  `;m([f({type:Array})],W.prototype,"receipts",void 0);m([f({type:Object})],W.prototype,"receiptDispatcher",void 0);W=m([Z("iaux-mgc-receipts")],W);let O=class extends g{constructor(){super(...arguments),this.patronName="",this.receipts=[],this.updates=[],this.viewToDisplay="welcome"}createRenderRoot(){return this}get receiptListElement(){return this.querySelector("iaux-mgc-receipts")}updateReceived(t){this.receiptListElement.emailSent({id:t.donationId,emailStatus:t.status}),this.updates.unshift(t)}get showReceiptsCTA(){return y`
      <iaux-button
        class="link"
    ...
    `}};m([f({type:String})],O.prototype,"patronName",void 0);m([f({type:Array})],O.prototype,"receipts",void 0);m([f({type:Array})],O.prototype,"updates",void 0);m([f({type:String,reflect:!0})],O.prototype,"viewToDisplay",void 0);O=m([Z("iaux-monthly-giving-circle")],O);class gt{constructor(t){this.id=t.id,this.amount=t.amount,this.date=t.date,this.isTest=t.isTest,this.token=t.token}}let te=[];const me=[new gt({amount:9999.99,date:new Date("2019-01-22 14:26:34").toLocaleString("US-EN",{year:"numeric",month:"short",day:"numeric"}),donor:"John Doe",paymentMethod:"Credit Card",status:"Completed",id:"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJtYWlsc3luYyIsImlhdCI6MTczNzk3MTgyNy45MDY1NDksIm5iZiI6MTczNzk3MTc2Ny45MDY1NDksImV4cCI6MTczNzk3MjQyNy45MDY1NDksImtleSI6IjEwOTY4MjEiLCJ1c2VyIjoiQGlzYS1hdC10aGUtYXJjaGl2ZSJ9.pMbayUlFgRhm3wDoJG1IPoltliTHDq0xH2W369JtdQA",token:"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJtYWlsc3luYyIsImlhdCI6MTczNzk3MTgyNy45MDY1NDksIm5iZiI6MTczNzk3MTc2Ny45MDY1NDksImV4cCI6MTczNzk3MjQyNy45MDY1NDksImtleSI6IjEwOTY4MjEiLCJ1c2VyIjoiQGlzYS1hdC10aGUtYXJjaGl2ZSJ9.pMbayUlFgRhm3wDoJG1IPoltliTHDq0xH2W369JtdQA",isTest:!1}),new gt({amount:100,date:new Date("2022-09-22 14:26:34").toLocaleString("US-EN",{year:"numeric",month:"short",day:"numeric"}),donor:"John Doe",paymentMethod:"Credit Card",status:"Completed",id:"foo-id-2",token:"foo-token-2",isTest:!0}),new gt({amount:100,date:new Date("2023-12-23 14:26:34").toLocaleString("US-EN",{year:"numeric",month:"short",day:"numeric"}),donor:"John Doe",paymentMethod:"Credit Card",status:"Completed",id:"foo-id-3",token:"foo-token-3",isTest:!1})];let _t=!0;const N=document.querySelector("iaux-monthly-giving-circle");N.receipts=me;N.addEventListener("EmailReceiptRequest",n=>{const t=document.getElementById("interaction-status-area"),{donation:e}=n.detail,i=Math.floor(Math.random()+.5),s=i===1?"success":"fail",o=i===1?3e3:8e3;t.innerText=`Email receipt request for donation ${e.id} will return ${s} in ${o} ms.`;const h={message:s==="success"?"Email receipt sent":"Email receipt failed",status:s,donationId:e.id};te=[h,...te],setTimeout(()=>{N.updateReceived(h),console.log("EmailReceiptRequest index.html ----",h),t.innerText=""},o)});document.getElementById("toggle-receipts").addEventListener("click",async()=>{if(_t){N.receipts=[],_t=!1;return}N.receipts=me,await N.updateComplete,_t=!0});
