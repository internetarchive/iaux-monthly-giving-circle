        ...
        <donation-form-section badgemode="hidebadge" headline="Amount">
          ${this.currentlyEditing?f:p` <p class="current-amount">
                ...
                <ia-button
                  ...
                  .clickHandler=${()=>{this.currentlyEditing=!0,this.updateStatus="",this.updateMessage=""}}
                >
                  Edit...
                </ia-button>`}
