...
\f\r"'\`<>=]|("|')|))|$)`,"g"),ve=/'/g,ge=/"/g,Re=/^(?:script|style|textarea|title)$/i,ci=o=>(t,...e)=>({_$litType$:o,strings:t,values:e}),p=ci(1),V=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),ye=new WeakMap,U=F.createTreeWalker(F,129,null,!1);function Fe(o,t){if(!Array.isArray(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return he!==void 0?he.createHTML(t):t}const ui=(o,t)=>{const e=o.length-1,i=[];let n,s=t===2?"<svg>":"",a=X;for(let l=0;l<e;l++){const r=o[l];let d,u,h=-1,m=0;for(;m<r.length&&(a.lastIndex=m,u=a.exec(r),u!==null);)m=a.lastIndex,a===X?u[1]==="!--"?a=pe:u[1]!==void 0?a=me:u[2]!==void 0?(Re.test(u[2])&&(n=RegExp("</"+u[2],"g")),a=D):u[3]!==void 0&&(a=D):a===D?u[0]===">"?(a=n??X,h=-1):u[1]===void 0?h=-2:(h=a.lastIndex-u[2].length,d=u[1],a=u[3]===void 0?D:u[3]==='"'?ge:ve):a===ge||a===ve?a=D:a===pe||a===me?a=X:(a=D,n=void 0);const f=a===D&&o[l+1].startsWith("/>")?" ":"";s+=a===X?r+li:h>=0?(i.push(d),r.slice(0,h)+Vt+r.slice(h)+M+f):r+M+(h===-2?(i.push(void 0),l):f)}return[Fe(o,s+(o[e]||"<?>")+(t===2?"</svg>":"")),i]};class ot{constructor({strings:t,_$litType$:e},i){let n;this.parts=[];let s=0,a=0;const l=t.length-1,r=this.parts,[d,u]=ui(t,e);if(this.el=ot.createElement(d,i),U.currentNode=this.el.content,e===2){const h=this.el.content,m=h.firstChild;m.remove(),h.append(...m.childNodes)}for(;(n=U.nextNode())!==null&&r.length<l;){if(n.nodeType===1){if(n.hasAttributes()){const h=[];for(const m of n.getAttributeNames())if(m.endsWith(Vt)||m.startsWith(M)){const f=u[a++];if(h.push(m),f!==void 0){const P=n.getAttribute(f.toLowerCase()+Vt).split(M),C=/([.?@])?(.*)/.exec(f);r.push({type:1,index:s,name:C[2],strings:P,ctor:C[1]==="."?pi:C[1]==="?"?vi:C[1]==="@"?gi:At})}else r.push({type:6,index:s})}for(const m of h)n.removeAttribute(m)}if(Re.test(n.tagName)){const h=n.textContent.split(M),m=h.length-1;if(m>0){n.textContent=j?j.emptyScript:"";for(let f=0;f<m;f++)n.append(h[f],it()),U.nextNode(),r.push({type:2,index:++s});n.append(h[m],it())}}}else if(n.nodeType===8)if(n.data===Ue)r.push({type:2,index:s});else{let h=-1;for(;(h=n.data.indexOf(M,h+1))!==-1;)r.push({type:7,index:s}),h+=M.length-1}s++}}static createElement(t,e){const i=F.createElement("template");return i.innerHTML=t,i}}function W(o,t,e=o,i){var n,s,a,l;if(t===V)return t;let r=i!==void 0?(n=e._$Co)===null||n===void 0?void 0:n[i]:e._$Cl;const d=nt(t)?void 0:t._$litDirective$;return r?.constructor!==d&&((s=r?._$AO)===null||s===void 0||s.call(r,!1),d===void 0?r=void 0:(r=new d(o),r._$AT(o,e,i)),i!==void 0?((a=(l=e)._$Co)!==null&&a!==void 0?a:l._$Co=[])[i]=r:e._$Cl=r),r!==void 0&&(t=W(o,r._$AS(o,t.values),r,i)),t}class hi{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:i},parts:n}=this._$AD,s=((e=t?.creationScope)!==null&&e!==void 0?e:F).importNode(i,!0);U.currentNode=s;let a=U.nextNode(),l=0,r=0,d=n[0];for(;d!==void 0;){if(l===d.index){let u;d.type===2?u=new lt(a,a.nextSibling,this,t):d.type===1?u=new d.ctor(a,d.name,d.strings,this,t):d.type===6&&(u=new yi(a,this,t)),this._$AV.push(u),d=n[++r]}l!==d?.index&&(a=U.nextNode(),l++)}return U.currentNode=F,s}v(t){let e=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class lt{constructor(t,e,i,n){var s;this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=n,this._$Cp=(s=n?.isConnected)===null||s===void 0||s}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=W(this,t,e),nt(t)?t===y||t==null||t===""?(this._$AH!==y&&this._$AR(),this._$AH=y):t!==this._$AH&&t!==V&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):di(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==y&&nt(this._$AH)?this._$AA.nextSibling.data=t:this.$(F.createTextNode(t)),this._$AH=t}g(t){var e;const{values:i,_$litType$:n}=t,s=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=ot.createElement(Fe(n.h,n.h[0]),this.options)),n);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===s)this._$AH.v(i);else{const a=new hi(s,this),l=a.u(this.options);a.v(i),this.$(l),this._$AH=a}}_$AC(t){let e=ye.get(t.strings);return e===void 0&&ye.set(t.strings,e=new ot(t)),e}T(t){Be(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,n=0;for(const s of t)n===e.length?e.push(i=new lt(this.k(it()),this.k(it()),this,this.options)):i=e[n],i._$AI(s),n++;n<e.length&&(this._$AR(i&&i._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,e);t&&t!==this._$AB;){const n=t.nextSibling;t.remove(),t=n}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}class At{constructor(t,e,i,n,s){this.type=1,this._$AH=y,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=y}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,n){const s=this.strings;let a=!1;if(s===void 0)t=W(this,t,e,0),a=!nt(t)||t!==this._$AH&&t!==V,a&&(this._$AH=t);else{const l=t;let r,d;for(t=s[0],r=0;r<s.length-1;r++)d=W(this,l[i+r],e,r),d===V&&(d=this._$AH[r]),a||(a=!nt(d)||d!==this._$AH[r]),d===y?t=y:t!==y&&(t+=(d??"")+s[r+1]),this._$AH[r]=d}a&&!n&&this.j(t)}j(t){t===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class pi extends At{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===y?void 0:t}}const mi=j?j.emptyScript:"";class vi extends At{constructor(){super(...arguments),this.type=4}j(t){t&&t!==y?this.element.setAttribute(this.name,mi):this.element.removeAttribute(this.name)}}class gi extends At{constructor(t,e,i,n,s){super(t,e,i,n,s),this.type=5}_$AI(t,e=this){var i;if((t=(i=W(this,t,e,0))!==null&&i!==void 0?i:y)===V)return;const n=this._$AH,s=t===y&&n!==y||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,a=t!==y&&(n===y||s);s&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;typeof this._$AH=="function"?this._$AH.call((i=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&i!==void 0?i:this.element,t):this._$AH.handleEvent(t)}}class yi{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){W(this,t)}}const fe=vt.litHtmlPolyfillSupport;fe?.(ot,lt),((Dt=vt.litHtmlVersions)!==null&&Dt!==void 0?Dt:vt.litHtmlVersions=[]).push("2.8.0");const fi=(o,t,e)=>{var i,n;const s=(i=e?.renderBefore)!==null&&i!==void 0?i:t;let a=s._$litPart$;if(a===void 0){const l=(n=e?.renderBefore)!==null&&n!==void 0?n:null;s._$litPart$=a=new lt(t.insertBefore(it(),l),l,void 0,e??{})}return a._$AI(o),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;class Ci extends S{static get styles(){return v`
  ...
  `;c([g({type:Array})],gt.prototype,"plans",void 0);gt=c([w("ia-mgc-plans")],gt);let yt=class extends S{constructor(){super(...arguments),this.titleStyle="heart"}get heart(){return this.titleStyle==="heart"?p` <div class="icon-donate"><ia-icon-donate></ia-icon-donate></div> `:y}render(){return p`
      <div>
        <h2>
...
`,_e={AF:"Afghanistan",AX:"Aland Islands",AL:"Albania",DZ:"Algeria",AS:"American Samoa",AD:"Andorra",AO:"Angola",AI:"Anguilla",AQ:"Antarctica",AG:"Antigua and Barbuda",AR:"Argentina",AM:"Armenia",AW:"Aruba",AU:"Australia",AT:"Austria",AZ:"Azerbaijan",BS:"Bahamas",BH:"Bahrain",BD:"Bangladesh",BB:"Barbados",BY:"Belarus",BE:"Belgium",BZ:"Belize",BJ:"Benin",BM:"Bermuda",BT:"Bhutan",BO:"Bolivia",BQ:"Bonaire, Saint Eustatius and Saba ",BA:"Bosnia and Herzegovina",BW:"Botswana",BV:"Bouvet Island",BR:"Brazil",IO:"British Indian Ocean Territory",VG:"British Virgin Islands",BN:"Brunei",BG:"Bulgaria",BF:"Burkina Faso",BI:"Burundi",KH:"Cambodia",CM:"Cameroon",CA:"Canada",CV:"Cape Verde",KY:"Cayman Islands",CF:"Central African Republic",TD:"Chad",CL:"Chile",CN:"China",CX:"Christmas Island",CC:"Cocos Islands",CO:"Colombia",KM:"Comoros",CK:"Cook Islands",CR:"Costa Rica",HR:"Croatia",CU:"Cuba",CW:"Curacao",CY:"Cyprus",CZ:"Czech Republic",CD:"Democratic Republic of the Congo",DK:"Denmark",DJ:"Djibouti",DM:"Dominica",DO:"Dominican Republic",TL:"East Timor",EC:"Ecuador",EG:"Egypt",SV:"El Salvador",GQ:"Equatorial Guinea",ER:"Eritrea",EE:"Estonia",ET:"Ethiopia",FK:"Falkland Islands",FO:"Faroe Islands",FJ:"Fiji",FI:"Finland",FR:"France",GF:"French Guiana",PF:"French Polynesia",TF:"French Southern Territories",GA:"Gabon",GM:"Gambia",GE:"Georgia",DE:"Germany",GH:"Ghana",GI:"Gibraltar",GR:"Greece",GL:"Greenland",GD:"Grenada",GP:"Guadeloupe",GU:"Guam",GT:"Guatemala",GG:"Guernsey",GN:"Guinea",GW:"Guinea-Bissau",GY:"Guyana",HT:"Haiti",HM:"Heard Island and McDonald Islands",HN:"Honduras",HK:"Hong Kong",HU:"Hungary",IS:"Iceland",IN:"India",ID:"Indonesia",IR:"Iran",IQ:"Iraq",IE:"Ireland",IM:"Isle of Man",IL:"Israel",IT:"Italy",CI:"Ivory Coast",JM:"Jamaica",JP:"Japan",JE:"Jersey",JO:"Jordan",KZ:"Kazakhstan",KE:"Kenya",KI:"Kiribati",XK:"Kosovo",KW:"Kuwait",KG:"Kyrgyzstan",LA:"Laos",LV:"Latvia",LB:"Lebanon",LS:"Lesotho",LR:"Liberia",LY:"Libya",LI:"Liechtenstein",LT:"Lithuania",LU:"Luxembourg",MO:"Macao",MK:"Macedonia",MG:"Madagascar",MW:"Malawi",MY:"Malaysia",MV:"Maldives",ML:"Mali",MT:"Malta",MH:"Marshall Islands",MQ:"Martinique",MR:"Mauritania",MU:"Mauritius",YT:"Mayotte",MX:"Mexico",FM:"Micronesia",MD:"Moldova",MC:"Monaco",MN:"Mongolia",ME:"Montenegro",MS:"Montserrat",MA:"Morocco",MZ:"Mozambique",MM:"Myanmar",NA:"Namibia",NR:"Nauru",NP:"Nepal",NL:"Netherlands",NC:"New Caledonia",NZ:"New Zealand",NI:"Nicaragua",NE:"Niger",NG:"Nigeria",NU:"Niue",NF:"Norfolk Island",KP:"North Korea",MP:"Northern Mariana Islands",NO:"Norway",OM:"Oman",PK:"Pakistan",PW:"Palau",PS:"Palestinian Territory",PA:"Panama",PG:"Papua New Guinea",PY:"Paraguay",PE:"Peru",PH:"Philippines",PN:"Pitcairn",PL:"Poland",PT:"Portugal",PR:"Puerto Rico",QA:"Qatar",CG:"Republic of the Congo",RE:"Reunion",RO:"Romania",RU:"Russia",RW:"Rwanda",BL:"Saint Barthelemy",SH:"Saint Helena",KN:"Saint Kitts and Nevis",LC:"Saint Lucia",MF:"Saint Martin",PM:"Saint Pierre and Miquelon",VC:"Saint Vincent and the Grenadines",WS:"Samoa",SM:"San Marino",ST:"Sao Tome and Principe",SA:"Saudi Arabia",SN:"Senegal",RS:"Serbia",SC:"Seychelles",SL:"Sierra Leone",SG:"Singapore",SX:"Sint Maarten",SK:"Slovakia",SI:"Slovenia",SB:"Solomon Islands",SO:"Somalia",ZA:"South Africa",GS:"South Georgia and the South Sandwich Islands",KR:"South Korea",SS:"South Sudan",ES:"Spain",LK:"Sri Lanka",SD:"Sudan",SR:"Suriname",SJ:"Svalbard and Jan Mayen",SZ:"Swaziland",SE:"Sweden",CH:"Switzerland",SY:"Syria",TW:"Taiwan",TJ:"Tajikistan",TZ:"Tanzania",TH:"Thailand",TG:"Togo",TK:"Tokelau",TO:"Tonga",TT:"Trinidad and Tobago",TN:"Tunisia",TR:"Turkey",TM:"Turkmenistan",TC:"Turks and Caicos Islands",TV:"Tuvalu",VI:"U.S. Virgin Islands",UG:"Uganda",UA:"Ukraine",AE:"United Arab Emirates",GB:"United Kingdom",UM:"United States Minor Outlying Islands",US:"United States",UY:"Uruguay",UZ:"Uzbekistan",VU:"Vanuatu",VA:"Vatican",VE:"Venezuela",VN:"Vietnam",WF:"Wallis and Futuna",EH:"Western Sahara",YE:"Yemen",ZM:"Zambia",ZW:"Zimbabwe"};let $=class extends S{constructor(){super(...arguments),this.selectedCountry="US",this.donorEmail=""}updated(t){var e;t.has("donorEmail")&&(this.emailField.value=(e=this.donorEmail)!==null&&e!==void 0?e:"")}reportValidity(){const t=[[this.emailField,this.emailBadgedInput],[this.firstNameField,this.firstNameBadgedInput],[this.lastNameField,this.lastNameBadgedInput],[this.regionField,this.regionBadgedInput],[this.localityField,this.localityBadgedInput],[this.streetAddressField,this.streetAddressBadgedInput],[this.postalCodeField,this.postalBadgedInput]];let e=!0;return t.forEach(([i,n])=>{const s=i.checkValidity();e=e&&s,s||(n.error=!0)}),e?this.errorMessage.innerText="":this.errorMessage.innerText="Please enter any missing contact information below",e}focus(){this.emailField.focus()}render(){return p`
  ...
  `;c([g({type:Object})],O.prototype,"plan",void 0);c([g({type:Boolean,reflect:!0})],O.prototype,"patronWantsToKeepPlan",void 0);c([g({type:Boolean,reflect:!0})],O.prototype,"initialCancelRequest",void 0);c([b("form")],O.prototype,"form",void 0);O=c([w("ia-mgc-cancel-plan")],O);let ft=class extends S{constructor(){super(...arguments),this.status=""}get glyph(){return this.status==="success"?"✓":this.status==="fail"?"✖":""}render(){return this.status?p`
