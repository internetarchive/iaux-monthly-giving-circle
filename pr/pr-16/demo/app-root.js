 ...
 */var Et;((Et=window.HTMLSlotElement)===null||Et===void 0?void 0:Et.prototype.assignedElements)!=null;const ni="mailto:donations@archive.org?subject=Please%20Confirm%20my%20Monthly%20Giving%20Circle%20Status&body=Dear%20Philanthropy%20Team%2C%0A%0AI%20am%20already%20a%20member%20of%20the%20Monthly%20Giving%20Circle%2C%20but%20I%20do%20not%20see%20my%20recurring%20donation%20under%20Account%20Settings.%20Please%20use%20the%20following%20information%20to%20locate%20my%20donation%3A%0A%0AFull%20name%3A%20____________%0A%0AEmail%20address(es)%3A%20____________%0A%0A*Please%20provide%20any%20alternative%20email%20addresses%20you%20may%20have%20used%20to%20create%20your%20recurring%20donation.%0A%0AIf%20you%20have%20access%20to%20a%20monthly%20donation%20receipt%2C%20please%20include%20a%20screenshot%20with%20your%20email.%0A%0AThanks!";let I=class extends A{constructor(){super(...arguments),this.patronName="",this.baseHost="archive.org",this.defaultMonthlyDonationAmount=5}render(){const t=`https://${this.baseHost}/donate/?amt=${this.defaultMonthlyDonationAmount}&contrib_type=monthly&origin=iawww-usrsttng`;return v`
  ...
  `;$([f({type:String})],I.prototype,"patronName",void 0);$([f({type:String})],I.prototype,"baseHost",void 0);$([f({type:String})],I.prototype,"defaultMonthlyDonationAmount",void 0);I=$([L("iaux-mgc-welcome")],I);const oi=v`
<svg
  viewBox="0 0 40 40"
...
`;class ri extends A{static get styles(){return z`
  ...
  `;$([f({type:Boolean,reflect:!0})],j.prototype,"isDisabled",void 0);$([f({type:Object})],j.prototype,"clickHandler",void 0);$([si("button")],j.prototype,"button",void 0);j=$([L("iaux-button")],j);let ot=class extends A{constructor(){super(...arguments),this.plans=[]}render(){return v`
      <section class="monthly-giving-circle">
        <ul>
          ${this.plans.map(t=>{var e,i,s,o,r,c,l,a,d,h,u,m,E,g,dt,ht,ut,pt;console.log(" ******** "),console.log("plan: ",t);const Ee=(i=(e=t.payment)===null||e===void 0?void 0:e.paymentMethodType)!==null&&i!==void 0?i:"Method not found",we=(o=(s=t.payment)===null||s===void 0?void 0:s.cardType)!==null&&o!==void 0?o:"Card type not found",xe=!((r=t.payment)===null||r===void 0)&&r.last4?`...${(c=t.payment)===null||c===void 0?void 0:c.last4}`:"CC number not found";return v`
              <li>
                <div class="info">
                  <div class="amount">
                    <h3>Amount</h3>
  ...
  `;$([f({type:Array})],ot.prototype,"plans",void 0);ot=$([L("iaux-mgc-plans")],ot);let rt=class extends A{constructor(){super(...arguments),this.titleStyle="heart"}get heart(){return this.titleStyle==="heart"?v` <div class="icon-donate"><ia-icon-donate></ia-icon-donate></div> `:p}render(){return v`
      <div>
        <h2>
  ...
  `;$([f({type:Array})],F.prototype,"receipts",void 0);$([f({type:Object})],F.prototype,"receiptDispatcher",void 0);F=$([L("iaux-mgc-receipts")],F);let D=class extends A{constructor(){super(...arguments),this.patronName="",this.receipts=[],this.updates=[],this.plans=[],this.viewToDisplay="welcome"}createRenderRoot(){return this}updated(t){t.has("plans")&&this.plans.length&&(this.viewToDisplay="plans")}get receiptListElement(){return this.querySelector("iaux-mgc-receipts")}updateReceived(t){this.receiptListElement.emailSent({id:t.donationId,emailStatus:t.status}),this.updates.unshift(t)}get showReceiptsCTA(){return v`
      <iaux-button
        class="link slim"
